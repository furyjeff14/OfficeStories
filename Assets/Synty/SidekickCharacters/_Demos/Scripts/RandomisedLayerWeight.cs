...
public class RandomisedLayerWeight : MonoBehaviour
{
    ...
    [Header("Random Variance MainMenuSettings")]
    ...
    [Header("Layer Weight MainMenuSettings")] // Changed header name to "Layer Weight Settings"
    ...
    [Header("Transition MainMenuSettings")]
